...
data_file.write("block,trial,type,frequency,heard,confidence,response_time,ear_perceived,pitch_type,correct\n")
...
# === FUNCTIONS ===
def create_dichotic_pitch(freq, wide=False):
...
for block_num in range(1, num_blocks + 1):
    ...
    for trial_num, freq in enumerate(block_trials):
        ...
        data_file.write(f"{block_num},{trial_num+1},{trial_type},{freq},{pitch_resp},{conf_resp},{rt:.3f},{ear_resp},{'high' if pitch_type_resp=='h' else 'low'},{correct}\n")
        data_file.flush()
        core.wait(0.5)
